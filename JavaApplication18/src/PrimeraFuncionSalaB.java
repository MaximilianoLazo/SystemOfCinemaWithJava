 ...
 * @author User
 */
public class PrimeraFuncionSalaB extends javax.swing.JFrame {
    ...
    public void botones(){
        ...
        for(int i=0;i<filas;i++){
            for(int j=0;j<columnas;j++){
               ...
               PrimeraFuncionSalaB.AccionBotones accion = new PrimeraFuncionSalaB.AccionBotones();
    ...
    public void reservarButaca(int numeroButaca){
        ...
        try {
            ...
            sql= "UPDATE reservaciones2a SET reservado = 'si' WHERE id_butaca = "+numeroButaca;
    ...
    public void quitarreservarcionButaca(int numeroButaca){
        ...
        try {
            ...
            sql= "UPDATE reservaciones2a SET reservado = 'no' WHERE id_butaca = "+numeroButaca;
            PreparedStatement ps = (PreparedStatement) cn.prepareStatement(sql);
            ps.executeUpdate();
            /**int mensaje = ps.executeUpdate();
            if (mensaje >0){
    ...
    public void buscarButacasReservadas(){
        try {
            ...
            sql= "SELECT id_butaca,reservado from reservaciones2a";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrimeraFuncionSalaB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrimeraFuncionSalaB().setVisible(true);
            }
        });
    }
