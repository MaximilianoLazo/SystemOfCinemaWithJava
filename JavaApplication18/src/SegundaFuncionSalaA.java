...
//import static SegundaFuncionSalaA.jTextField1;
...
public class SegundaFuncionSalaA extends javax.swing.JFrame {
      int filas=5;
    int columnas=6;
...
public void botones(){
        ...
        for(int i=0;i<filas;i++){
            for(int j=0;j<columnas;j++){
               ...
               SegundaFuncionSalaA.AccionBotones accion = new SegundaFuncionSalaA.AccionBotones();
    ...
    public void reservarButaca(int numeroButaca){
        ...
        try {
            ...
            sql= "UPDATE reservacionesb SET reservado = 'si' WHERE id_butaca = "+numeroButaca;
    ...
    public void quitarreservarcionButaca(int numeroButaca){
        ...
        try {
            ...
            sql= "UPDATE reservacionesb SET reservado = 'no' WHERE id_butaca = "+numeroButaca;
            PreparedStatement ps = (PreparedStatement) cn.prepareStatement(sql);
            ps.executeUpdate();
            /**int mensaje = ps.executeUpdate();
            if (mensaje >0){
    ...
    public void buscarButacasReservadas(){
        try {
            ...
            sql= "SELECT id_butaca,reservado from reservacionesb";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Estado de la segunda función");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SegundaFuncionSalaA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SegundaFuncionSalaA().setVisible(true);
            }
        });
    }
