//import static TerceraFuncionSalaA.jTextField1;
...
public class TerceraFuncionSalaA extends javax.swing.JFrame {
    ...
    public void botones(){
        ...
        for(int i=0;i<filas;i++){
            for(int j=0;j<columnas;j++){
               ...
               TerceraFuncionSalaA.AccionBotones accion = new TerceraFuncionSalaA.AccionBotones();
    ...
    public void reservarButaca(int numeroButaca){
        ...
        try {
            ...
            sql= "UPDATE reservacionesc SET reservado = 'si' WHERE id_butaca = "+numeroButaca;
    ...
    public void quitarreservarcionButaca(int numeroButaca){
        ...
        try {
            ...
            sql= "UPDATE reservacionesc SET reservado = 'no' WHERE id_butaca = "+numeroButaca;
            PreparedStatement ps = (PreparedStatement) cn.prepareStatement(sql);
            ps.executeUpdate();
            /**int mensaje = ps.executeUpdate();
            if (mensaje >0){
    ...
    public void buscarButacasReservadas(){
        try {
            ...
            sql= "SELECT id_butaca,reservado from reservacionesc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TerceraFuncionSalaA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TerceraFuncionSalaA().setVisible(true);
            }
        });
    }
