//import static PrimeraFuncionSalaA.jTextField1;
...
public class CuartaFuncionSalaA extends javax.swing.JFrame {

    /**
     * Creates new form CuartaFuncionSalaA
     */
    public CuartaFuncionSalaA() {
        initComponents();
        botones();
       ...
       public void botones(){
        ...
        for(int i=0;i<filas;i++){
            for(int j=0;j<columnas;j++){
             ...
             CuartaFuncionSalaA.AccionBotones accion = new CuartaFuncionSalaA.AccionBotones();
    ...
    public void reservarButaca(int numeroButaca){
        ...
        try {
            ...
            sql= "UPDATE reservacionesd SET reservado = 'si' WHERE id_butaca = "+numeroButaca;
    ...
    public void quitarreservarcionButaca(int numeroButaca){
        ...
        try {
            ...
            sql= "UPDATE reservacionesd SET reservado = 'no' WHERE id_butaca = "+numeroButaca;
            PreparedStatement ps = (PreparedStatement) cn.prepareStatement(sql);
            ps.executeUpdate();
            /**int mensaje = ps.executeUpdate();
            if (mensaje >0){
    ...
    public void buscarButacasReservadas(){
        try {
            ...
            sql= "SELECT id_butaca,reservado from reservacionesd";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Estado de la CUARTA funciÓn");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuartaFuncionSalaA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CuartaFuncionSalaA().setVisible(true);
            }
        });
    }
